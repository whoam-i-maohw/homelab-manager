...
def test_download_youtube_videos_from_txt_file_to_channel_name_dir_happy_path(
    ...
    expected_downloaded_file = (
        f"{os.path.join(download_root_path, "s", "Simon Yapp", "TEST VIDEO")}"
    )
    ...
    for success in successes:
        ...
        assert success.download_path == os.path.dirname(expected_downloaded_file)
...
def test_download_youtube_videos_from_txt_file_to_channel_name_dir_invalid_file_path(
    browser_cookie_path: str | None,
) -> None:
